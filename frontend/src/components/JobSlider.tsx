        ...
        >
          {loading ? (
            Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex-none w-[280px] min-w-[280px] max-w-[280px] sm:w-[320px] sm:min-w-[320px] sm:max-w-[320px] h-[185px] bg-white dark:bg-[#161b22] border border-gray-100 dark:border-gray-800 rounded-xl p-4 snap-start scroll-ml-4 sm:scroll-ml-6">
            ...
            jobs.map(job => (
              <div key={job.id} className="snap-start scroll-ml-4 sm:scroll-ml-6 flex-none w-[280px] min-w-[280px] max-w-[280px] sm:w-[320px] sm:min-w-[320px] sm:max-w-[320px] h-[185px]">
                <JobCard job={job} />
              </div>
            ))
          )}
