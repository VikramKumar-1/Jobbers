        ...
        >
          {loading ? (
            Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="flex-none w-[280px] sm:w-[320px] h-[170px] bg-white dark:bg-[#161b22] border border-gray-100 dark:border-gray-800 rounded-xl p-4 snap-start">
